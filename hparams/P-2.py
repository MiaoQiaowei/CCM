...
def _hparams(algorithm, dataset, random_seed):
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('lr', 2.7028930742148706e-05, lambda r: 10**r.uniform(-5, -3.5))

    if dataset in SMALL_IMAGES:
        _hparam('weight_decay', 0., lambda r: 0.)
    else:
        _hparam('weight_decay', 0.00044832883881609976, lambda r: 10**r.uniform(-6, -2))
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('batch_size', 39, lambda r: int(2**r.uniform(3, 5.5)))
