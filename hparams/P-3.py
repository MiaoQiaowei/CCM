...
def _hparams(algorithm, dataset, random_seed):
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('lr', 2.95623643291898e-05, lambda r: 10**r.uniform(-5, -3.5))

    if dataset in SMALL_IMAGES:
        _hparam('weight_decay', 0., lambda r: 0.)
    else:
        _hparam('weight_decay', 0.0002016579493930936, lambda r: 10**r.uniform(-6, -2))
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('batch_size', 37, lambda r: int(2**r.uniform(3, 5.5)))
