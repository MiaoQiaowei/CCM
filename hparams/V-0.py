...
def _hparams(algorithm, dataset, random_seed):
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('lr', 2.259509333895171e-05, lambda r: 10**r.uniform(-5, -3.5))

    if dataset in SMALL_IMAGES:
        _hparam('weight_decay', 0., lambda r: 0.)
    else:
        _hparam('weight_decay', 0.0038093795402535276, lambda r: 10**r.uniform(-6, -2))
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('batch_size', 24, lambda r: int(2**r.uniform(3, 5.5)))
